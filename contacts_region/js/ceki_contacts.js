...
(function cekiContacts(exports) {
  ...
  exports.cekiContactsList = [
    ...
    },
    {
      ...
      position: 'Заместитель начальника отдела координации региональной цифровизации Департамента координации и реализации проектов по цифровой экономике Минкомсвязи России',
    ...
    },
    {
      ...
      position: 'Ведущий специалист управления по координации, мониторингу и реализации региональной цифровизации Департамента координации региональной цифровизации ФГБУ «ЦЭКИ»',
