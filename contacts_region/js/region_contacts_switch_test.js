    ...
    newElement.innerHTML = `<table>
                              <tbody>
                                <tr>
                                  ...
                                  <td class="text name" colspan="2"><a target="_blank" href="/view_doc.html?mode=my_conversations_minsvyaz">${item.name}</a></td>
                                </tr>
                                <tr>
      ...
      <table>
        <tbody>
          <tr>
            ...
            <td class="text name" colspan="2"><a target="_blank" href="/view_doc.html?mode=my_conversations_minsvyaz">${item.name}</a>
            </td>
          </tr>
          <tr>
