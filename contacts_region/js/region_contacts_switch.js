...
const renderContactsCeki = function (array) {
  ...
  array.forEach(function (item) {
    ...
    newElement.innerHTML = '<table><tbody><tr><td class="foto test" rowspan="4"><img src="' + item.foto + '" alt="Фото"></td><td class="text name" colspan="2"><a target="_blank" href="/view_doc.html?mode=my_conversations_minsvyaz">' + item.name + '</a></td></tr><tr><td class="text position" colspan="2">' + item.position + '</td></tr><tr><td class="ico"><img src="' + window.cekiContacts.linkForWebtutor + 'icon/ico_tel.svg" alt="Иконка телефона"></td><td class="text contact">' + item.phone + '</td></tr><tr><td class="ico"><img src="' + window.cekiContacts.linkForWebtutor + 'icon/ico_mail.svg" alt="Почта иконка"></td><td class="text contact"><a href="mailto:' + item.email + '">' + item.email + '</a></td></tr><tr><td class="text question" colspan="3">' + item.question + '</td></tr></tbody></table>';
...
const renderRegionContactsCard = function (arr) {
  ...
  arr.forEach(function (item) {
    const newElement = document.createElement('div');
    newElement.classList.add('contact-card', 'ceki');
    newElement.innerHTML = '<table><tbody><tr><td class="foto" rowspan="4"><img alt="Фото" src="' + item.photo + '" /></td><td class="text name" colspan="2"><a target="_blank" href="/view_doc.html?mode=my_conversations_minsvyaz">' + item.name + '</a></td></tr><tr><td class="text position" colspan="2">' + item.position + '</td></tr><tr><td class="ico"><img alt="Иконка телефона" src="' + window.cekiContacts.linkForWebtutor + 'icon/ico_tel.svg" /></td><td class="text contact">' + item.phone + '</td></tr><tr><td class="ico"><img alt="Почта иконка" src="' + window.cekiContacts.linkForWebtutor + 'icon/ico_mail.svg" /></td><td class="text contact"><a href="mailto:' + item.email + '">' + item.email + '</a></td></tr></tbody></table>';
