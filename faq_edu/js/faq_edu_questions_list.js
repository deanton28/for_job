...
(function questionData(exports) {
  exports.departamentalProgrammDigitalTransfprmation = [
    ...
    },
    {
      ...
      answer: 'Проект постановления правительства о цифровой трансформации органов государственной власти представлен в разделе «Библиотека» на портале, а также его можно запросить у курирующего ФОИВ аккаунт менеджера.',
    },
    {
    ...
    {
      question: 'Что делать с планом информатизации и мероприятиями 2020 годом, у нас план информатизации готов уже и все закупки опубликованы',
      answer: 'План по информатизации на 2020 пока действует, его никто не отменял.<br>После выхода нового постановления, будет дополнительно разъяснятся правила перехода на форму ВПЦТ',
    },
    {
    ...
    },
    {
      ...
      answer: 'С учетом того, что указываемые в рамках ведомственной программы цифровой трансформации средства будут после согласования программы доводиться органу государственной власти с использованием системы Электронный бюджет, планируемые органом государственной власти средства должны отражать реальные потребности.<br>При этом обращаем внимание, что ведомственные программы могут корректироваться органами государственной власти, что позволяет детализировать сведения в течении года.',
    },
    {
    ...
    {
      question: 'Можно ли включать межведомственные проекты ведомственную программу цифровой трансформации?',
